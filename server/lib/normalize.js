...
exports.normalizeFragrance = normalizeFragrance;
exports.normalizeFragrances = normalizeFragrances;
/**
 * Map Fragella gender flags to internal Gender type
 */
function mapGender(fragrance) {
 ...
 */
function mapScentFamily(fragrance) {
    ...
    if (searchText.includes('sandalwood') ||
    ...
    if (searchText.includes('aquatic') ||
 ...
 */
function getAllNoteNames(fragrance) {
    const names = [];
 ...
 */
function extractNotes(fragrance) {
    const extractFromArray = (notes) => {
        if (!notes)
            return [];
        return notes
 ...
 */
function normalizeFragrance(fragrance, index = 0) {
 ...
 */
function normalizeFragrances(fragrances) {
